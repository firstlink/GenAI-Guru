...
export function CurriculumTimeline() {
  return (
    <section id="curriculum" className="py-16 md:py-24 bg-secondary/30">
              ...
              >
                ...
                <div className="flex-1 w-full text-center md:text-left">
                  <div className={`flex flex-col ${index % 2 === 0 ? "md:items-start" : "md:items-end"}`}>
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold font-heading mb-3">{mod.title}</h3>
                    <p className="text-sm sm:text-base text-muted-foreground mb-4 max-w-xs mx-auto md:mx-0">{mod.desc}</p>
                ...
                <div className="relative z-10 shrink-0">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-white shadow-xl shadow-primary/10 border border-primary/10 flex items-center justify-center p-3 sm:p-4 transform transition-transform hover:scale-110 duration-300">
