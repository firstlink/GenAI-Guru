...
export function CareerStats() {
  return (
    <section id="career" className="py-16 md:py-20 bg-primary text-white overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 lg:gap-12 text-center">
          {stats.map((stat, i) => (
            ...
            >
              <h3 className="text-3xl sm:text-4xl md:text-6xl font-bold font-heading mb-2 tracking-tight">
                {stat.value}
              </h3>
